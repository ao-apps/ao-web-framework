 ...
 * Copyright (C) 2006-2009, 2015, 2016, 2021, 2022, 2025  AO Industries, Inc.
...
public class TreePageData {
   ...
   */
  public TreePageData(String url, String description, boolean hasChildren, Collection<String> path) {
    this(
        url,
        description,
        hasChildren,
